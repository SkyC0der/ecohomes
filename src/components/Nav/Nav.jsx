...
const Nav = () => {
  ...
  // Per-section menu button light/dark toggle
  useEffect(() => {
    ...
    const lightSections = document.querySelectorAll(
      ".what-we-do, .featured-projects-container, .client-reviews-container, .gallery-callout, .footer"
    );
    ...
    lightSections.forEach((section) => {
      triggers.push(
        ScrollTrigger.create({
          ...
          onEnter: () => { lightCount++; menuToggle.classList.add("on-light"); },
          onLeave: () => { lightCount = Math.max(0, lightCount - 1); if (!lightCount) menuToggle.classList.remove("on-light"); },
          onEnterBack: () => { lightCount++; menuToggle.classList.add("on-light"); },
          onLeaveBack: () => { lightCount = Math.max(0, lightCount - 1); if (!lightCount) menuToggle.classList.remove("on-light"); },
        })
      );
    });
        ...
        <div className="menu-wrapper">
          <div className="col col-1">
            <div className="links">
              ...
              <div className={`link${pathname === "/studio" ? " active" : ""}`}>
                <a
                  href="/studio"
              ...
              <div className={`link${pathname === "/spaces" ? " active" : ""}`}>
                <a
                  href="/spaces"
              ...
              <div className={`link${pathname === "/blueprints" ? " active" : ""}`}>
                <a
                  href="/blueprints"
